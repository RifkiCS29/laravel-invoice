...
Langkah-Langkah
1. Download Source Code dari repo Github laravel-invoice dalam bentuk Zip.
2. Extract file zip (source code) ke dalam direktori htdocs pada XAMPP, misal htdocs/laravel-invoice.
3. Melalui terminal, cd ke direktori laravel-invoice.
...
7. Buat database baru (kosong) pada mysql (via phpmyadmin) dengan nama <b>laravel-invoice</b>.
...
10. Setting koneksi database di file .env (DB_DATABASE, DB_USERNAME, DB_PASSWORD).
    ...
    <br>DB_PORT=3306
    <br>DB_DATABASE=laravel-invoice
    <br>DB_USERNAME=root
    <br>DB_PASSWORD=
...
13. Jalankan perintah <b>php artisan db:seed</b> untuk mengisi tabel users yang digunakan untuk proses login
